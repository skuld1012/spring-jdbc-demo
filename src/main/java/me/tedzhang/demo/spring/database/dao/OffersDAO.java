package me.tedzhang.demo.spring.database.dao;
...
public class OffersDAO {
	...
	public Offer getOfferById(int id) {
		...
		return this.jdbc.queryForObject("select * from offers where id = :id;", params, new RowMapper<Offer>() {
	...
	public boolean delete(int id) {
		...
		return jdbc.update("delete from offers when id=:id", params) == 1;
	}
